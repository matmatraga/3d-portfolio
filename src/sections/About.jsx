...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText( "matthewmondoy.raga@gmail.com" );
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">With 1.5 year of experience, I have honed my skills in frontend and backend development.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white">matthewmondoy.raga@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
